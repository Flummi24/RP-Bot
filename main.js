(async () => {
    try {
    const res = await fetch("https://raw.githubusercontent.com/Flummi24/RP-Bot/main/version.json")
    ...
    if (Number(local.value) < Number(data.value)) {
        ...
        console.log("[UPDATE] Lade sie Hier Runter: https://github.com/Flummi24/RP-Bot")
